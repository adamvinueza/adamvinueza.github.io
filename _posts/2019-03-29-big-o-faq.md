...
QED<sup>[\*](#qedfootnote)</sup>.<a name="#return"/>
...
<sup>[\*](#return)</sup> <a name="qedfootnote">I once took a mathematics class in which the professor
ended each of his proofs with the acronym _ATWMR_, which stood for "And there
was much rejoicing.</a>
